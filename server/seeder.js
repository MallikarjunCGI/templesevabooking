...
const importData = async () => {
    try {
        ...
        const hashedCounterPassword = await bcrypt.hash('counter123', salt);
        ...
        const users = await User.insertMany([
            ...
            {
                name: 'Counter1',
                email: 'counter1@temple.com',
                password: hashedCounterPassword,
                role: 'counter',
                phone: '9000000001'
            },
            {
                name: 'Counter2',
                email: 'counter2@temple.com',
                password: hashedCounterPassword,
                role: 'counter',
                phone: '9000000002'
            },
